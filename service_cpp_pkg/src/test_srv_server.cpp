...
void add(const std::shared_ptr<msg_srv_pkg::srv::SumSrv::Request> request,     // CHANGE
          std::shared_ptr<msg_srv_pkg::srv::SumSrv::Response>       response)  // CHANGE
{
...
int main(int argc, char **argv)
{
  ...
  rclcpp::Service<msg_srv_pkg::srv::SumSrv>::SharedPtr service =                 // CHANGE
    node->create_service<msg_srv_pkg::srv::SumSrv>("add_three_ints",  &add);     // CHANGE
